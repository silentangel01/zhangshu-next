...
var BaseTransitionImpl = {
	...
	setup(props, { slots }) {
		...
		return () => {
			...
			let enterHooks = resolveTransitionHooks$1(innerChild, rawProps, state, instance, (hooks) => enterHooks = hooks);
			...
			if (oldInnerChild && oldInnerChild.type !== Comment$1 && !isSameVNodeType(oldInnerChild, innerChild) && recursiveGetSubtree(instance).type !== Comment$1) {
				let leavingHooks = resolveTransitionHooks$1(oldInnerChild, rawProps, state, instance);
...
function resolveTransitionHooks$1(vnode, props, state, instance, postClone) {
	...
	return baseResolveTransitionHooks({
		...
		cloneHooks: (vnode) => {
			const hooks = resolveTransitionHooks$1(vnode, props, state, instance, postClone);
		...
		return () => {
			...
			if (children) for (let i = 0; i < children.length; i++) {
				...
				if (child.el && child.el instanceof Element) {
					...
					setTransitionHooks(child, resolveTransitionHooks$1(child, cssTransitionProps, state, instance));
			...
			for (let i = 0; i < children.length; i++) {
				const child = children[i];
				if (child.key != null) setTransitionHooks(child, resolveTransitionHooks$1(child, cssTransitionProps, state, instance));
...
function applyGroupTransitionHooks(block, props, state, instance) {
	...
	for (let i = 0; i < children.length; i++) {
		const child = children[i];
		if (isValidTransitionBlock(child)) if (child.$key != null) setTransitionHooks$1(child, resolveTransitionHooks(child, props, state, instance));
...
//#endregion
export { setClassName as $, readonly as $a, setTransitionHooks as $i, createRenderer as $n, isVNode as $r, vModelCheckboxInit as $t, createVaporSSRApp as A, withDefaults as Aa, provide as Ai, Text$1 as An, hasInjectionContext as Ar, ensureRenderer as At, isFragment as B, effectScope as Ba, resolveComponent as Bi, cloneVNode as Bn, isAsyncWrapper as Br, patchStyle as Bt, createKeyedFragment as C, warnExtraneousAttributes as Ca, onUpdated as Ci, MismatchTypes as Cn, getCurrentInstance as Cr, baseUseCssVars as Ct, createTemplateRefSetter as D, watchPostEffect as Da, performTransitionLeave as Di, Static as Dn, guardReactiveProps as Dr, defineCustomElement as Dt, createSlot as E, watchEffect as Ea, performTransitionEnter as Ei, SchedulerJobFlags as En, getTransitionRawChildren as Er, createSSRApp as Et, delegate as F, ReactiveEffect as Fa, registerHMR as Fi, baseNormalizePropsOptions as Fn, initCustomFormatter as Fr, hydrate as Ft, prepend as G, isReadonly as Ga, resolveTarget as Gi, createBaseVNode as Gn, isMemoSame as Gr, shouldSetAsPropForVueCE as Gt, next as H, getCurrentWatcher as Ha, resolveDynamicComponent as Hi, computed as Hn, isHydrating as Hr, resolveTransitionProps as Ht, delegateEvents as I, TrackOpTypes as Ia, registerRuntimeCompiler as Ii, baseResolveTransitionHooks as In, initFeatureFlags as Ir, initDirectivesForSSR as It, setAttr as J, markRaw as Ja, setCurrentInstance as Ji, createCommentVNode as Jn, isSetEqual as Jr, useCssModule as Jt, remove as K, isRef as Ka, resolveTransitionHooks$1 as Ki, createBlock as Kn, isMismatchAllowed as Kr, svgNS as Kt, getDefaultValue as L, TriggerOpTypes as La, renderList as Li, callWithAsyncErrorHandling as Ln, inject as Lr, nodeOps as Lt, defineVaporComponent as M, withMemo as Ma, pushWarningContext as Mi, activate as Mn, hydrateOnInteraction as Mr, getValue as Mt, defineVaporCustomElement as N, withScopeId as Na, queueJob as Ni, assertNumber as Nn, hydrateOnMediaQuery as Nr, handleMovedChildren as Nt, createTextNode as O, watchSyncEffect as Oa, popScopeId as Oi, Suspense as On, h as Or, defineSSRCustomElement as Ot, defineVaporSSRCustomElement as P, EffectScope as Pa, queuePostFlushCb as Pi, baseEmit as Pn, hydrateOnVisible as Pr, hasCSSTransform as Pt, setClass as Q, reactive as Qa, setRef as Qi, createPropsRestProxy as Qn, isTemplateRefKey as Qr, vModelCheckbox as Qt, getRestElement as R, customRef as Ra, renderSlot as Ri, callWithErrorHandling as Rn, invalidateMount as Rr, normalizeContainer as Rt, createInvoker as S, warn as Sa, onUnmounted as Si, KeepAlive as Sn, getComponentName as Sr, baseApplyTranslation as St, createSelector as T, watch as Ta, performAsyncHydrate as Ti, NULL_DYNAMIC_COMPONENT as Tn, getInheritedScopeIds as Tr, createApp as Tt, nthChild as U, isProxy as Ua, resolveFilter as Ui, createAppAPI as Un, isKeepAlive as Ur, setVarsOnNode as Ut, isVaporComponent as V, getCurrentScope as Va, resolveDirective as Vi, compatUtils as Vn, isEmitListener as Vr, render as Vt, on as W, isReactive as Wa, resolvePropValue as Wi, createAsyncComponentContext as Wn, isMapEqual as Wr, shouldSetAsProp as Wt, setBlockKey as X, onWatcherCleanup as Xa, setDevtoolsHook as Xi, createHydrationRenderer as Xn, isTeleportDisabled as Xr, useHost as Xt, setBlockHtml as Y, onScopeDispose as Ya, setCurrentRenderingInstance as Yi, createElementBlock as Yn, isTeleportDeferred as Yr, useCssVars as Yt, setBlockText as Z, proxyRefs as Za, setIsHydratingEnabled$1 as Zi, createInternalObject as Zn, isTemplateNode as Zr, useShadowRoot as Zt, createComponentWithFallback as _, useTemplateRef as _a, onErrorCaptured as _i, Comment$1 as _n, toHandlerKey as _o, ensureValidVNode as _r, Transition as _t, VaporKeepAlive as a, toClassSet as aa, mergeDefaults as ai, vModelSetSelected as an, toRaw as ao, deactivate as ar, setInsertionState as at, createForSlots as b, validateProps as ba, onRenderTriggered as bi, ErrorTypeStrings as bn, flushOnAppMount as br, VueElement as bt, VaporTransitionGroup as c, transformVNodeArgs as ca, nextTick as ci, vModelTextUpdate as cn, toValue as co, defineEmits as cr, setText as ct, applyRadioModel as d, useAttrs as da, normalizeVNode as di, vShowOriginalDisplay as dn, camelize as do, defineOptions as dr, txt as dt, shouldUpdateComponent as ea, isValidHtmlOrSvgAttribute as ei, vModelCheckboxUpdate as en, ref as eo, createSlots as er, setDOMProp as et, applySelectModel as f, useId as fa, onActivated as fi, withKeys as fn, capitalize as fo, defineProps as fr, useVaporCssVars as ft, createComponent as g, useSlots as ga, onDeactivated as gi, BaseTransitionPropsValidators as gn, toDisplayString as go, endMeasure as gr, withVaporDirectives as gt, child as h, useSSRContext as ha, onBeforeUpdate as hi, BaseTransition as hn, normalizeStyle as ho, devtoolsComponentAdded as hr, withVaporCtx as ht, VaporFragment as i, startMeasure as ia, matches as ii, vModelSelectInit as in, stop as io, currentInstance as ir, setHtml as it, defineVaporAsyncComponent as j, withDirectives as ja, pushScopeId as ji, VaporSlot as jn, hydrateOnIdle as jr, forceReflow as jt, createVaporApp as k, withCtx as ka, popWarningContext as ki, Teleport as kn, handleError as kr, ensureHydrationRenderer as kt, applyCheckboxModel as l, unregisterHMR as la, nextUid as li, vShow as ln, triggerRef as lo, defineExpose as lr, setValue as lt, applyVShow as m, useModel as ma, onBeforeUnmount as mi, xlinkNS as mn, normalizeProps as mo, devtools as mr, withAsyncContext as mt, DynamicFragment as n, ssrContextKey as na, leaveCbKey as ni, vModelRadio as nn, shallowReadonly as no, createTextVNode as nr, setDynamicProps as nt, VaporTeleport as o, toHandlers as oa, mergeModels as oi, vModelText as on, toRef as oo, defineAsyncComponent as or, setProp as ot, applyTextModel as p, useInstanceOption as pa, onBeforeMount as pi, withModifiers as pn, normalizeClass as po, defineSlots as pr, vaporInteropPlugin as pt, renderEffect as q, isShallow as qa, setBlockTracking as qi, createCanSetSetupRefChecker as qn, isRuntimeOnly as qr, unsafeToTrustedHTML as qt, VaporElement as r, ssrUtils as ra, markAsyncBoundary as ri, vModelSelect as rn, shallowRef as ro, createVNode as rr, setElementText as rt, VaporTransition as s, toStyleMap as sa, mergeProps as si, vModelTextInit as sn, toRefs as so, defineComponent as sr, setStyle as st, compile as t, simpleSetCurrentInstance as ta, knownTemplateRefs as ti, vModelDynamic as tn, shallowReactive as to, createStaticVNode as tr, setDynamicEvents as tt, applyDynamicModel as u, useAsyncComponentState as ua, normalizeRef as ui, vShowHidden as un, unref as uo, defineModel as ur, template as ut, createDynamicComponent as v, useTransitionState as va, onMounted as vi, DeprecationTypes as vn, ensureVaporSlotFallback as vr, TransitionGroup as vt, createPlainElement as w, warnPropMismatch as wa, openBlock as wi, MoveType as wn, getFunctionalFallthrough as wr, callPendingCbs as wt, createIf as x, version as xa, onServerPrefetch as xi, Fragment as xn, getAttributeMismatch as xr, VueElementBase as xt, createFor as y, validateComponentName as ya, onRenderTracked as yi, ErrorCodes as yn, expose as yr, TransitionPropsValidators as yt, insert as z, effect as za, resetShapeFlag as zi, checkTransitionMode as zn, invokeDirectiveHook as zr, patchProp as zt };

//# sourceMappingURL=vue.runtime.esm-bundler-vA_P-Dl5.js.map