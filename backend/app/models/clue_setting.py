...
class ClueSetting(Base):
    __tablename__ = "clue_settings"

    id: Mapped[str] = mapped_column(String(36), primary_key=True, index=True)
    project_id: Mapped[str] = mapped_column(String(36), ForeignKey("projects.id"), nullable=False, index=True)
    clue_id: Mapped[str] = mapped_column(String(36), ForeignKey("clues.id"), nullable=False, index=True)
    setting_item_id: Mapped[str] = mapped_column(String(36), ForeignKey("setting_items.id"), nullable=False, index=True)
